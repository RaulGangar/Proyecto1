...
public class CrearObjetosPokemon {
	...
	public static void main(String[] args) {
		...
		// declaramos las variables al principio
		String nombre = "";
		float precio = 0;
		int numero = 0;
		int conteo = 0;
		...
		/*
		 * do { try { precio = Float.parseFloat(sc.nextLine()); } catch (Exception e) {
		 * System.out.println("Por favor inserte un numero entero"); } } while (precio
		 * <= 0);
		 */
		...
		do {
			try {
				...
				if (conteo < 3) {
					...
					System.out.println("BORRICO, METE UN NUMERO ENTERO!!");
				conteo++;
			}
