...
import com_elorrieta_objetos.Cancion;
...
public class CancionesPiperrak {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Cancion mas larga: " + cMasLarga.getNombre() + " " + cMasLarga.getDuracion() + "segundos");
		System.out.println("Cancion mas Corta: " + cMasCorta.getNombre() + " " + cMasCorta.getDuracion() + "segundos");
	}
}
